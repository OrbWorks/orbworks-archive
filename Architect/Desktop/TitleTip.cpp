...
BOOL CTitleTip::Create(CWnd * pParentWnd)
{
    ...
    m_fonttDefault.CreateStockObject(DEFAULT_GUI_FONT);
                     ...
                     LPLOGFONT lpLogFont /*=NULL*/)
{
    ...
    CFont *pOldFont = NULL;
    pOldFont =dc.SelectObject(&m_fonttDefault);
    ...
    //m_rectDisplay.top  += 2;
    m_rectDisplay.right = m_rectDisplay.left + size.cx;
    ...
    CFont *pFontDC = dc.SelectObject(&m_fonttDefault );
    ...
    */
    ...
    SetWindowPos( &wndTop, 
        ...
        m_rectDisplay.top-2, 
        m_rectDisplay.Width()+7, 
        m_rectDisplay.Height()+5,

...
if (app) {
	var projname = FullPath("..\\..\\OrbForms\\OrbLaunch\\OrbLaunch.mcp");
	...
	projname = FullPath("..\\..\\OrbForms\\OrbFormsRT\\OrbFormsRT.mcp");
	...
	projname = FullPath("..\\PalmCompiler\\PCA.mcp");
	project = app.OpenProject(projname, true, 0, 0);

	if (project) {
		var msgs = project.BuildAndWaitToCompleteWithOptions(0);
	} else {
		WScript.Echo("Unable to open PCA project");
	}

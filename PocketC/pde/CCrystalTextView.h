...
#define  xisalnum(c) (isalnum(c) || (c)=='_')
#define  xisalpha(c) (isalpha(c) || (c)=='_')
...
protected:
    ...
    DWORD ParseLineOrbForms (DWORD dwCookie, int nLineIndex, TEXTBLOCK * pBuf, int &nActualItems);
